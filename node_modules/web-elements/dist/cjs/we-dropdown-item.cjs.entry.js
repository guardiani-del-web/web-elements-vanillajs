...
const DropdownItem = class {
    constructor(hostRef) {
        ...
        this.clickItemCallback = index.createEvent(this, "clickItemCallback", 7);
    }
    manageTransition() {
        if (this.width) {
