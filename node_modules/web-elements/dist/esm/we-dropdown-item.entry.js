...
const DropdownItem = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: 'dropdown_item ' + this.borderClass, onClick: this.handleItemClicked.bind(this) }, this.label ? h("label", null, this.label) : h("slot", { name: "item_content" }), this.arrow && (h("div", { class: "arrowContainer", onClick: () => this.handleChangeState() }, h("i", { class: 'arrow ' + this.arrowState })))), h("div", { class: 'children position_' + this.positionChildren, style: {
