...
var AccordionGroup = /** @class */ (function () {
    ...
    AccordionGroup.prototype.accordionCallbackHandler = function (event) {
        var value = event.detail;
        if (!this.multiple) {
            var accordions = this.el.querySelectorAll('we-accordion');
    ...
    Object.defineProperty(AccordionGroup.prototype, "el", {
...
export { Accordion as we_accordion, AccordionGroup as we_accordion_group };
