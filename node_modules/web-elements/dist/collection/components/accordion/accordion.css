...
:host we-accordion:first-of-type {
...
:host .accordion {
  ...
  box-shadow: var(--container-box-shadow, 0 -0.063rem 0 #e5e5e5, 0 0 0.125rem rgba(0, 0, 0, 0.12), 0 0.125rem 0.25rem rgba(0, 0, 0, 0.24));
}
:host .accordion .accordion-title {
  ...
  -webkit-user-select: var(--title-user-select, none);
     -moz-user-select: var(--title-user-select, none);
      -ms-user-select: var(--title-user-select, none);
          user-select: var(--title-user-select, none);
}
:host .accordion .accordion-title:before {
...
:host .accordion .accordion-content {
...
:host .accordion .accordion-close {
  position: absolute;
  height: 3.375rem;
  width: 100%;
  top: 0;
...
:host input:checked + .accordion {
  height: auto;
}
:host input:checked + .accordion .accordion-title {
  border-bottom: var(--title-border-bottom-opened, 0.063rem solid rgba(0, 0, 0, 0.18));
}
:host input:checked + .accordion .accordion-title:before {
  transform: var(--title-transform-opened, rotate(90deg));
}
:host input:checked + .accordion .accordion-content,
:host input:checked + .accordion .accordion-close {
